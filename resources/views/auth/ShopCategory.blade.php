    ...
    <main>
        ...
        <div class="new-product-section shop">
            ...
            <div class="product-content">
                ...
                @if ($product['category_id'] === $CategoriesID['id'])
                    

                <div class="product">
                    <a href="{{route("product",$product['id'])}}">
                        <img style="height: 170px !important;   "  src="{{url($product['image'])}}">
                    </a>
                ...
                <div class="product-detail"> 
                        ...
                        <p style="margin-right:  21px !important;">${{$product['SellingPrice']}}</p>
                    </div>
                </div>
